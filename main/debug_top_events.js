...
// Mock data and functions from server.js
...
// Configuration
const startDate = new Date(Date.UTC(2025, 10, 1)); // 2025-11-01
const endDate = new Date(Date.UTC(2025, 10, 30)); // 2025-11-30
...
async function run() {
    ...
    const historicoPath = path.join(__dirname, 'historico_eventos.csv');
    ...
    // Check for our hardcoded events
