...
// --- Configurações ---
const DATA_INICIO = '2025-12-21';
const DATA_FIM = '2026-01-18';
const NOME_ARQUIVO_SAIDA = 'historico_eventos.csv';
const URL_API = 'https://analytics.google.com/analytics/app/data/v2/venus?accessmode=read&reportId=dashboard_card_3&dataset=p151460007&fpn=287695367178&authuser=5&hl=pt_BR&gamonitor=firebase&state=app.reports.reports.dashboard';
